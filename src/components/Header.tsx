  ...
  return (
    <header className="flex justify-between items-center p-5 shadow-md">
      ...
      <div className="hidden md:flex space-x-4 pr-10 lg:pr-48">
        <Link href="/" className="text-xl font-semibold hover:text-green-600 transition-colors duration-500">
          home
        </Link>
        <Link href="/about" className="text-xl font-semibold hover:text-green-600 transition-colors duration-500">
          about
        </Link>
      </div>
      <MobileMenu />
